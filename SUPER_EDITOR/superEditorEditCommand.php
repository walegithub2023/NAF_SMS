...
include('../Connection.php');
  ...
  if(isset($_POST['update'])){
        ...
        //create a function to validate command input
...
try{
     ...
     $updateSQL = "UPDATE commands SET COMMAND = '$command', REMARK = '$remark'  WHERE COMMAND_CODE = '$commandCode'";
    ...
    //get command code and fetch selected command's record and assign them to variables
 
    if(isset($_GET['commandCode'])){
     $commandCode = $_GET['commandCode'];
     $commandSQL = "SELECT * FROM commands WHERE COMMAND_CODE = '$commandCode'";
     $commandResult = mysqli_query($conn, $commandSQL);

 
    while($row = mysqli_fetch_assoc($commandResult)){
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="superEditorHome" class="logo d-flex align-items-center">
    ...
    <div class="search-bar">
      <form method="post" action="superEditorNewUser" class="search-form d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="superEditorUserProfile">
...
<main id="main" class="main">
   ...
   <!-- php block of code to display success, failure or error message ends -->
              ...
              <!-- Multi Columns Form -->
              <form method="post" action="superEditorEditCommand" class="row g-3">
                <div class="col-md-12">
                  <label for="commandCode" class="form-label">Command code</label>
                  <input type="text" value="<?php echo $row['COMMAND_CODE']; ?>" name="commandCode" class="form-control" id="commandCode" placeholder="Enter command code" style="background-color:#f5f8f9;" readonly>
                </div>
                <div class="col-md-12">
                  <label for="command" class="form-label">Command</label>
                  <input type="text" value="<?php echo $row['COMMAND']; ?>" name="command" class="form-control" id="command" placeholder="Enter command in full" required>
                </div>
                 <div class="col-md-12">
                  <label for="remark" class="form-label">Remark</label>
                  <input type="text" value="<?php echo $row['REMARK']; ?>" name="remark" class="form-control" id="remark" placeholder="Enter command remark">
                </div>
                <div class="col-12">
