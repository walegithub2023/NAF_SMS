...
include('../functions.php');
    ...
    if(isset($_GET['inspectionId'])){
        ...
        $deleteSQL = "DELETE FROM vehicle_inspection WHERE id = '$inspectionId'";

       $deleteResult = mysqli_query($conn, $deleteSQL);

       if($deleteResult == true){
        
                $_SESSION["successMessageForDeleteVehicleInspection"] = "<div class='alert alert-dismissible' style='background-color: #198754; color:white; font-size:120%; text-align:center;
          ...
          //declare or prepare variables for log_event function
                ...
                $action = "delete";
                $description = "$userSvcNo"." "." deleted a vehicle inspection from the database";
                ...
                <a href='unitAdminVehicle' class='close' data-dismiss='alert' aria-label='close' style='color:white; font-size:120%; text-align:left;
                font-family:Arial; text-decoration:none; padding:0px'>&times;</a>
                YOUR ATTEMPT TO DELETE A VEHICLE INSPECTION HAS FAILED......
                </div>";

        //declare or prepare variables for log_event function
                $userSvcNo = $_SESSION['svcNo'];
                $action = "failed attempt";
                $description = "$userSvcNo"." "." tried deleting a vehicle inspection from the database";
                $account = $_SESSION['account'];
