            ...
            <div class="table-responsive" style="boder">
              <table class="table datatable table-striped second table-hover" style="text-transform:uppercase; font-size:90%; background-color:white;">
                ...
                <tbody>
                    ...
                    <tr>
                    <td scope="col">3</td>
                    <td scope="col"><img src="../IMAGES/opms.png" style="width:350px; height:200px;"></td>
                    <td scope="col">OPMS Dashboard</td>
                    <td scope="col">Click the Dashboard link on the sidebar to navigate to one of the Dashboards (SMS or OPMS).</td>
                    <td scope="col">The Dashboard pages show or give analytics of the unit's pers, leave and passes, etc.</td>
                    <td scope="col">NIL</td>
                    </tr>
                </tbody>
              </table>
